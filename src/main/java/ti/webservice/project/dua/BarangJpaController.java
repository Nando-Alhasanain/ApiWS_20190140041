...
import ti.webservice.project.dua.exceptions.NonexistentEntityException;
import ti.webservice.project.dua.exceptions.PreexistingEntityException;
...
public class BarangJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ti.webservice_project.dua_jar_0.0.1-SNAPSHOTPU");
